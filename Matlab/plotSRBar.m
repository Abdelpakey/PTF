...
% if plot_average_in_bar
%     line_id_avg=n_lines*inter_bar_gap_ratio + 0.40;
%     if ~horz_bar_plot
%         bar_ids(n_lines + 1) = bar(line_id_avg, mean(values(:, 1)),...
%             'Parent', gca,...
%             'BarWidth', bar_width,...
%             'LineWidth', bar_line_width,...
%             'LineStyle', line_styles{1},...
...
%             'EdgeColor', col_rgb{strcmp(col_names,'black')});
%     else
%         bar_ids(n_lines + 1) = barh(line_id_avg, mean(values(:, 1)),...
%             'Parent', gca,...
%             'BarWidth', bar_width,...
%             'LineWidth', bar_line_width,...
%             'LineStyle', line_styles{1},...
...
%     if length(line_styles)>1  
%         if ~horz_bar_plot
%             bar(line_id_avg + intra_bar_gap, mean(values(:, 2)),...
%                 'Parent', gca,...
%                 'BarWidth', bar_width,...
%                 'LineWidth', bar_line_width,...
%                 'LineStyle', line_styles{2},...
...
%                 'EdgeColor', col_rgb{strcmp(col_names,'black')});
%         else
%             barh(line_id_avg + intra_bar_gap, mean(values(:, 2)),...
%                 'Parent', gca,...
%                 'BarWidth', bar_width,...
%                 'LineWidth', bar_line_width,...
%                 'LineStyle', line_styles{2},...
...
%         if annotate_bar_legend
%             if annotate_with_ratio
%                 labels{n_lines + 1}=sprintf('Average:%.2f',...
%                     mean(values(:, 1))/ mean(values(:, 2)));
%             else
%                 labels{n_lines + 1}=sprintf('Average:%.2f',mean(values(:, 1)));
%             end
%         end
%     end
%     if annotate_bars
...
%             annotation('textbox',...
%                 [0 0 0.3 0.15],...
%                 'String', sprintf('%.2f',mean(values(:, bar_id))),...
%                 'FontSize',annotation_font_size,...
%                 'FontWeight','bold',...
%                 'FontName','Times New Roman',...
%                 'LineStyle','-',...
