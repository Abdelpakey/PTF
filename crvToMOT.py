root_dir = 'C:/Datasets/IDOT/groundTruth'
seq_names = ['245837_FAI-74_E_of_St._Joseph_in_Champaign_County_20150630_09am',
...
out_fname = '{:s}/{:s}_mot.txt'.format(root_dir, seq_name)
...
for line in in_data:
    ...
    out_fid.write('{:d},{:d},{:d},{:d},{:d},{:d},1,-1,-1,-1\n'.format(
        frame_id + 1, obj_id, x, y, width, height))
    line_id += 1
    if line_id % 100 == 0:
