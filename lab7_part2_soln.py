...
# import watershed_soln as watershed
# import watershed_weird as watershed
import watershed
...
img, contours, hierarchy = cv2.findContours(np.copy(labels), mode=cv2.RETR_CCOMP, method=cv2.CHAIN_APPROX_NONE)
